...
export function AboutWrapper({}) {
  const [text, setText] = useState({
    main: "Featured Work",
    para: `Experienced academic professional and tech entrepreneur with 7+ years in teaching and institutional leadership.`,
  });
  useEffect(() => {
    if (!isDesktop()) {
      setText({
        main: "Achievements",
        para: `Institutional leader and tech entrepreneur with 7+ years of experience in high-end digital solutions.`,
      });
    }
  }, []);
  return (
