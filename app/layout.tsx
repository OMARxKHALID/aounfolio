...
export const metadata: Metadata = {
  title: "Syed Aoun Jafry • Academic Leader & Tech Entrepreneur",
  description:
    "Syed Aoun Jafry is an experienced academic professional, institutional leader, and technology entrepreneur with over 7 years of teaching experience.",
};
